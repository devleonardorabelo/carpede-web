  ...
  return (
    <section className="fluid-container footer">
        <footer className="container">
            <div className="logo">
                <Link href="/">
                    <a className="logo" href=""><img src="/images/logo-carpede-white.png" alt="Carpede" title="Carpede" /></a>
                </Link>
            </div>
            ...
            <div className="media">
                <h5>REDES SOCIAIS</h5>
                <a href="https://www.instagram.com/carpededelivery" target="_blank" className="instagram">Instagram</a>
